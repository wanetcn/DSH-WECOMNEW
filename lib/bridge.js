...
export class Bridge {
  constructor(ctx, config) {
    ...
    this.stats = { totalSessions: 0, messagesIn: 0, messagesOut: 0 };
  ...
  async start() {
    ...
    try {
      ...
      if (typeof raw === 'object' && raw !== null) {
        this.stats.totalSessions = Number(raw.totalSessions) || 0;
  ...
  async createChat(key, userId) {
    ...
    // One more historical session for the web status panel.
